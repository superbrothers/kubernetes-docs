...
```
      ...
      --allow-metric-labels-manifest string                            The path to the manifest file that contains the allow-list mapping. The format of the file is the same as the flag --allow-metric-labels, i.e., 
                                                                       allowListMapping:
      ...
      --concurrent-device-taint-eviction-syncs int32                   The number of operations (evicting pods, updating DeviceTaintRule status) allowed to run concurrently. Greater number = more responsive, but more CPU (and network) load (default 8)
      --concurrent-disruption-syncs int32                              The number of PDB objects that are allowed to sync concurrently. Larger number = more responsive PDB updates, but more CPU (and network) load (default 1)
      ...
      --concurrent-resourceclaim-syncs int32                           The number of operations (creating or deleting ResourceClaims) allowed to run concurrently. Larger number = more responsive, but more CPU (and network) load (default 50)
      ...
      --controller-shutdown-timeout duration                           Time to wait for the controllers to shut down before terminating the executable (default 10s)
      ...
      --emulated-version strings                                       The versions different components emulate their capabilities (APIs, features, ...) of.
                                                                       ...
                                                                       Options are: kube=1.34..1.37(default:1.37)
      ...
      --feature-gates colonSeparatedMultimapStringString               Comma-separated list of component:key=value pairs that describe feature gates for alpha/experimental features of different components.
                                                                       ...
                                                                       kube:APIServerWebhookAuthenticationToken=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:AllowUnsafeMalformedObjectDeletion=true|false (BETA - default=true)
                                                                       kube:AtomicFIFO=true|false (BETA - default=true)
                                                                       kube:AtomicWriteVolumeUserFields=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:CRDObservedGenerationTracking=true|false (BETA - default=true)
                                                                       kube:CRIListStreaming=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:ClientsAllowCARotation=true|false (BETA - default=true)
                                                                       kube:ClientsAllowCBOR=true|false (ALPHA - default=false)
                                                                       kube:ClientsAllowTLSCacheGC=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:CompositePodGroup=true|false (ALPHA - default=false)
                                                                       kube:ConcurrentWatchObjectDecode=true|false (BETA - default=true)
                                                                       kube:ConsistentListFromCacheSkipTimeoutFallback=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:ControllerManagerReleaseLeaderElectionLockOnExit=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:DRAConsumableCapacity=true|false (BETA - default=true)
                                                                       kube:DRADerivedAttributes=true|false (ALPHA - default=false)
                                                                       kube:DRADeviceBindingConditions=true|false (BETA - default=true)
                                                                       kube:DRADeviceCompatibilityGroups=true|false (ALPHA - default=false)
                                                                       kube:DRAFractionalCapacityRange=true|false (BETA - default=false), or DRAFractionalCapacityRange=true|false (BETA - default=true) if --min-compatibility-version>=1.37
                                                                       kube:DRAListTypeAttributes=true|false (ALPHA - default=false)
                                                                       kube:DRANodeAllocatableResources=true|false (ALPHA - default=false)
                                                                       kube:DRAOptionalNodeOperations=true|false (ALPHA - default=false)
                                                                       kube:DRAPartitionableDevices=true|false (BETA - default=true)
                                                                       kube:DRAPartitionableDevicesType=true|false (ALPHA - default=false)
                                                                       kube:DRAResourceClaimGranularStatusAuthorization=true|false (BETA - default=true)
                                                                       kube:DRAResourcePoolStatus=true|false (ALPHA - default=false)
                                                                       kube:DRASchedulerFilterTimeout=true|false (BETA - default=true)
                                                                       kube:DRAWorkloadResourceClaims=true|false (BETA - default=false)
                                                                       kube:DeclarativeValidationBeta=true|false (BETA - default=true)
                                                                       kube:DefaultPodSysctls=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:EmptyDirVolumeMode=true|false (ALPHA - default=false)
                                                                       kube:EnvFiles=true|false (BETA - default=true)
                                                                       kube:EtcdRangeStream=true|false (BETA - default=true)
                                                                       kube:EventedPLEG=true|false (ALPHA - default=false)
                                                                       kube:EvictionRequestAPI=true|false (ALPHA - default=false)
                                                                       kube:ExcludeAdmissionWebhookVirtualResources=true|false (BETA - default=true)
                                                                       kube:ExtendWebSocketsToKubelet=true|false (BETA - default=true)
                                                                       kube:GRPCContainerProbeTLS=true|false (ALPHA - default=false)
                                                                       kube:GenericWorkload=true|false (BETA - default=false)
                                                                       ...
                                                                       kube:H2CContainerProbe=true|false (ALPHA - default=false)
                                                                       kube:HPAGeneration=true|false (BETA - default=true)
                                                                       kube:HPAOptimizedSelectorStore=true|false (BETA - default=true)
                                                                       kube:HPAScaleToZero=true|false (BETA - default=true)
                                                                       kube:HugepageAwareEviction=true|false (BETA - default=true)
                                                                       kube:ImageVolumeWithDigest=true|false (ALPHA - default=false)
                                                                       kube:InOrderInformersBatchProcess=true|false (BETA - default=true)
                                                                       kube:InPlacePodLevelResourcesVerticalScaling=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:InPlacePodVerticalScalingMemoryBackedVolumes=true|false (ALPHA - default=false)
                                                                       kube:InPlacePodVerticalScalingSchedulerPreemption=true|false (ALPHA - default=false)
                                                                       kube:InterPodAffinityHostnameFastPath=true|false (ALPHA - default=false)
                                                                       kube:KubeProxyNFTablesLocalhostNodePorts=true|false (ALPHA - default=false)
                                                                       kube:KubeletAllocatedPodsEndpoint=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:KubeletInUserNamespace=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:ManifestBasedAdmissionControlConfig=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:MemoryQoS=true|false (BETA - default=true)
                                                                       kube:MutablePVNodeAffinity=true|false (ALPHA - default=false)
                                                                       kube:MutablePodResourcesForSuspendedJobs=true|false (BETA - default=true)
                                                                       kube:MutableSchedulingDirectivesForSuspendedJobs=true|false (BETA - default=true)
                                                                       kube:NFTablesNetlink=true|false (BETA - default=true)
                                                                       kube:NativeHistograms=true|false (BETA - default=true)
                                                                       kube:NodeControllerLeaseCircuitBreaker=true|false (BETA - default=true)
                                                                       kube:NodeLifecycleConditions=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:PersistentVolumeClaimUnusedSinceTime=true|false (BETA - default=true)
                                                                       kube:PodAndContainerStatsFromCRI=true|false (BETA - default=false)
                                                                       kube:PodDeletionCost=true|false (BETA - default=true)
                                                                       kube:PodGroupPreemptionPolicy=true|false (ALPHA - default=false)
                                                                       kube:PodLevelResourceManagers=true|false (BETA - default=false)
                                                                       kube:PodLevelResources=true|false (BETA - default=true)
                                                                       kube:PodLevelResourcesFixDefaulting=true|false (BETA - default=true)
                                                                       kube:PodLevelResourcesFixKubeletQOSClass=true|false (BETA - default=true)
                                                                       kube:PodLogsQuerySplitStreams=true|false (ALPHA - default=false)
                                                                       kube:PodTopologyLabelsAdmission=true|false (BETA - default=true)
                                                                       kube:PodsAPI=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:ReloadKubeletClientCAFile=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:ResourceHealthStatus=true|false (BETA - default=true)
                                                                       kube:ResourceHealthStatusMessage=true|false (BETA - default=true)
                                                                       kube:RestartAllContainersOnContainerExits=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:SchedulerAsyncAPICalls=true|false (BETA - default=false)
                                                                       kube:SchedulerAsyncPreemption=true|false (BETA - default=true)
                                                                       kube:SchedulerPopFromBackoffQ=true|false (BETA - default=true)
                                                                       kube:SchedulerPreQueueingHints=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:StaleControllerConsistencyDaemonSet=true|false (BETA - default=true)
                                                                       kube:StaleControllerConsistencyHPA=true|false (BETA - default=true)
                                                                       kube:StaleControllerConsistencyJob=true|false (BETA - default=true)
                                                                       kube:StaleControllerConsistencyReplicaSet=true|false (BETA - default=true)
                                                                       kube:StaleControllerConsistencyStatefulSet=true|false (BETA - default=true)
                                                                       kube:StatefulSetRecreateStrategy=true|false (ALPHA - default=false)
                                                                       kube:StatefulSetSemanticRevisionComparison=true|false (BETA - default=true)
                                                                       kube:StorageCapacityScoring=true|false (BETA - default=true)
                                                                       kube:StorageVersionAPI=true|false (ALPHA - default=false)
                                                                       kube:StorageVersionHash=true|false (BETA - default=true)
                                                                       kube:StrictIPCIDRValidation=true|false (BETA - default=true)
                                                                       ...
                                                                       kube:TopologyAwareWorkloadScheduling=true|false (ALPHA - default=false)
                                                                       ...
                                                                       kube:UnlockWhileProcessingFIFO=true|false (BETA - default=true)
                                                                       kube:UserNamespacesHostNetworkSupport=true|false (ALPHA - default=false)
                                                                       kube:VolumeBindMountOptions=true|false (ALPHA - default=false)
                                                                       kube:VolumeLimitScaling=true|false (BETA - default=true)
                                                                       kube:WatchList=true|false (BETA - default=true)
                                                                       kube:WatchListClient=true|false (BETA - default=true)
                                                                       kube:WatchListCompression=true|false (BETA - default=true)
                                                                       kube:WebhookRoundTripLoadBalancing=true|false (BETA - default=true)
  ...
  -h, --help                                                           help for kube-controller-manager
      ...
      --min-compatibility-version strings                              The min version of control plane components the server should be compatible with.
                                                                       ...
                                                                       Options are: kube=1.34..1.37(default:1.36)
                                                                       If the component is not specified, defaults to "kube"
      ...
      --node-monitor-period duration                                   The period for syncing NodeStatus in NodeLifecycleController. (default 5s)
